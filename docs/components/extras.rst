...
* `ROCm Validation Suite <https://rocm.docs.amd.com/projects/ROCmValidationSuite/en/docs-1.4.21/install/installation.html>`_ (RVS) -- A suite of tests for validating ROCm installations
